...
--create-disk=auto-delete=yes,boot=yes,device-name=instance-1,image=projects/debian-cloud/global/images/debian-11-bullseye-v20230912,mode=rw,size=100,type=projects/$GC_PROJECT/zones/$ZONE/diskTypes/pd-ssd \
